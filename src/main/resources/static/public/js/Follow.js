const follower=document.getElementById("followerCont");
const following=document.getElementById("followingCont");
...
async function toggleFollowing(toId){//내가 팔로우하고 있는 팔로잉 유저 목록에 있는 삭제 버튼
    alert("분기2: 팔로잉 삭제")
